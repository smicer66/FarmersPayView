          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="float-left"><h3 class="card-title">All Payment Schedules</h3></div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
  $(function () {
	...
	var url = '/list-payment-schedule-api';
    $("#example1").DataTable({
		"ajax": {
			dataType: "JSON",  
			type: "GET",
