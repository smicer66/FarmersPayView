  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Payment Schedule for {{$scheduleName}}</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="float-left"><h3 class="card-title">Payment Schedule for {{$scheduleName}}</h3></div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th class="text-right">Amount To Pay (ZMW)</th>
                  </tr>
                  </thead>
                  <tbody>
                  </tbody>
...
<script>
  $(function () {
	...
	var url = '/list-payment-schedule-breakdown-api/' + {{$id}};
	console.log(url);
    $("#example1").DataTable({
		"ajax": {
			dataType: "JSON",  
		...
		"columns": [
			{ data: 'id' },
			{ data: 'farmGroupName' },
			{ data: 'amountToPay', className: "text-right" }
		],
