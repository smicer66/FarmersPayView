    ...
    <div class="ui-panel login-panel animated bounceInDown">
        <header>
            ...
            <div class="left logo" style="padding-top: 30px !important;">
                <img class="logo_image" src="/images/farmerspay.jpg" alt="" width="120"><br>
                <a href="/"><span>Farmers</span>Pay</a>
            </div>
        ...
        <form class="" method="post" id="login" action="/login">
            <div class="login-form" style="clear: both !important">
                    ...
                    <input type="email" name="username" placeholder="Username" required value="260967307151">
                    <input type="password" name="password" placeholder="Password" required value="passwordzaq1ZAQ!">
            </div>
	 ...
	 <footer style="padding-bottom: 50px !important; padding-top: 15px !important;">
            <div class="right social-login">
                <a href="/register" class="ui-button inactive login">New Farmer? Sign Up</a>
            </div>
